...
export default function DashboardLayout({
  ...
  return (
    <ErrorBoundary>
      <DemoProvider>
      <GamificationWrapper>
      <div className="flex min-h-screen bg-gradient-to-br from-slate-100 via-lime-50/20 to-emerald-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        <Sidebar />
